          ...
          <div className="p-8 md:p-10 flex flex-col justify-center bg-white">
            ...
            <div className="pt-2 space-y-3">
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-center gap-3 py-4 border border-[#E5E7EB] hover:bg-slate-50 bg-white text-[#111827] text-xs font-black uppercase tracking-widest rounded-full transition-all active:scale-[0.98] shadow-md"
              >
